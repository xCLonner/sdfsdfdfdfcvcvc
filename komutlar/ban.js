...
exports.run = (client, message, args) => {
  ...
  if (reason.length < 1) return message.reply('Ban sebebini yazmalısın <a:blobBan:504229377605763072>');
  if (message.mentions.users.size < 1) return message.reply('Kimi banlayacağını yazmalısın <a:blobBan:504229377605763072>').catch(console.error);
